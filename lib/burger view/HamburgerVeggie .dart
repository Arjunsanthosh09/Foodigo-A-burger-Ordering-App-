...
class HamburgerVeggie extends StatefulWidget {
  const HamburgerVeggie({Key? key}) : super(key: key);

  @override
  State<HamburgerVeggie> createState() => _HamburgerVeggieState();
}

class _HamburgerVeggieState extends State<HamburgerVeggie> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Image.asset(
                        "assets/images/veggie.png", // Placeholder image, user will add their own
                        height: 250,
                        fit: BoxFit.contain,
                      ),
                    ),
